...
function setup() {
  ...
  soldire = createSprite(windowWidth / 2, windowHeight / 2, 10, 10);
 ...
 invisible.visible=false;
  ...
  fountain2 = createSprite(windowWidth - 50, 45, 30, 45);
  ...
  fountain3 = createSprite(30, windowHeight - 70, 20, 20);
  ...
  fountain4 = createSprite(windowWidth - 50, windowHeight - 70, 20, 20);
...
function draw() {
  ...
  fill("black");
textSize(20);
text("Score:"+ score,windowWidth/14,40,40);
  text("Lives Left: "+Lives,windowWidth-200,40);
  text("KILL:"+kill,windowWidth/2,windowHeight/20,20,20);
...
bulletLeft();
  ...
  if((score===20)&& kill===150){
    ...
    stroke("Dark black");
    textSize(75);
    text("MISSION PASSED",windowWidth/3,windowHeight/3);
...
function ZombieRight() {
  ...
  var Zombie = new zombie(windowWidth, Math.round(random(50, windowHeight - 50)));
  Zombie.display();
 
}

function ZombieLeft() {
  var Zombie = new zombieRight(0, Math.round(random(50, windowHeight - 50)));
  Zombie.display();
}
